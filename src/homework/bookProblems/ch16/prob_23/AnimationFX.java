package homework.bookProblems.ch16.prob_23;
...
public class AnimationFX {
    ...
    private static TextField audio = new TextField(new File("src/homework/ch16/prob_23", "anthem2.mp3").toURI().toString());

    private static File file = new File("src/homework/ch16/prob_23/image", prefix+current+".gif");
